...
//                   ],
//                 ),
//                 trailing: (FirebaseFirestore.instance
...
//         .get().)
//                     ? ElevatedButton(
//                         onPressed: (startDateDateTime.isAfter(DateTime.now()) ||
//                                 (startDateDateTime
//                                         .isAtSameMomentAs(DateTime.now()) &&
//                                     (contestData['startTime']
//                                             .isAfter(TimeOfDay.now()) &&
//                                         contestData['endTime'].isAtSameMomentAs(
//                                             TimeOfDay.now()))))
//                             ? () {
...
//                             MaterialPageRoute(
//                               builder: (context) =>
//                                   registerContest(contestDetails: contestData),
//                             ),
//                           );
//                         },
