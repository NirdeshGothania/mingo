...
//   Future<void> fetchTotalMarks(String email) async {
//     try {
//       var snapshot = await FirebaseFirestore.instance
//           .collection('createContest')
//           .doc(widget.contestDetails!['contestId'])
...
//       setState(() {
//         totalMarks[email] = total;
//       });
//     } catch (e) {
//       print('Error fetching total marks for $email: $e');
//     }
//   }
...
//                 var studentTotalMarks = totalMarks[email] ?? 0;
...
//                         ],
//                       ),
//                       Text('Total Marks: $studentTotalMarks'),
//                     ],
//                   ),
...
class _StudentListState extends State<StudentList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: displayedData.isEmpty
          ? Center(
              child: showViolationsOnly
                  ? const Text('No violations happened')
